...
Every failure inside rigor-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`rigor.cli._output`,
...
# Exit-code policy. Documented in ``rigor-cli learn`` output.
# 0      = success
